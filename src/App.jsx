      ...
      <div className="flex items-center justify-center">
        <div className="flex flex-col items-center mr-4">
          ...
          <div className="flex items-center">
            <button
              className="bg-slate-600 hover:bg-slate-800 text-white font-bold py-2 px-4 rounded-l"
              onClick={() => handleSessionLengthChange(-1)}
              disabled={timerRunning}
            >
              -
            </button>
            <p className="text-white text-lg font-medium px-4">{sessionLength}</p>
            <button
              className="bg-slate-600 hover:bg-slate-800 text-white font-bold py-2 px-4 rounded-r"
              onClick={() => handleSessionLengthChange(1)}
              disabled={timerRunning}
            >
              +
        ...
        <div className="flex flex-col items-center ml-4">
          ...
          <div className="flex items-center">
            ...
            <p className=" text-white text-lg font-medium px-4">{breakLength}</p>
            <button
              className="bg-slate-600 hover:bg-slate-800 text-white font-bold py-2 px-4 rounded-r"
              onClick={() => handleBreakLengthChange(1)}
              disabled={timerRunning}
        ...
        <div className="flex flex-col items-center ml-8">
          ...
          <div className="flex items-center">
            ...
            <p className=" text-white text-lg font-medium px-4">{longBreakLength}</p>
            <button
              className="bg-slate-600 hover:bg-slate-800 text-white font-bold py-2 px-4 rounded-r"
              onClick={() => handleLongBreakLengthChange(1)}
              disabled={timerRunning}
